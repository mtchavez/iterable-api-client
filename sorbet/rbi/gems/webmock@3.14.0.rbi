...
# source://webmock//lib/webmock/http_lib_adapters/net_http.rb#266
class Net::WebMockNetBufferedIO < ::Net::BufferedIO
  # @return [WebMockNetBufferedIO] a new instance of WebMockNetBufferedIO
  #
  # source://webmock//lib/webmock/http_lib_adapters/net_http.rb#267
  ...
  #
  # source://webmock//lib/webmock/http_lib_adapters/net_http.rb#291
  def rbuf_fill; end
end
...
class StubSocket
  ...
  # @return [Boolean]
  #
  # source://webmock//lib/webmock/http_lib_adapters/net_http.rb#245
  def closed?; end
  ...
  # source://webmock//lib/webmock/http_lib_adapters/net_http.rb#255
  def io; end
...
module WebMock
  ...
  class << self
    # source://webmock//lib/webmock/webmock.rb#131
    ...
    # source://webmock//lib/webmock/webmock.rb#97
    ...
    # @return [Boolean]
    #
    # source://webmock//lib/webmock/webmock.rb#135
    ...
    # source://webmock//lib/webmock/webmock.rb#122
    def reset_webmock; end

    # source://webmock//lib/webmock/webmock.rb#93
    def show_body_diff!; end

    # @return [Boolean]
    #
    # source://webmock//lib/webmock/webmock.rb#101
    def show_body_diff?; end
...
class WebMock::BodyPattern
  ...
  # source://webmock//lib/webmock/request_pattern.rb#293
  def to_s; end

  private

  # source://webmock//lib/webmock/request_pattern.rb#315
  def assert_non_multipart_body(content_type); end

  # source://webmock//lib/webmock/request_pattern.rb#299
  def body_as_hash(body, content_type); end

  # source://webmock//lib/webmock/request_pattern.rb#310
  def body_format(content_type); end

  # @return [Boolean]
  #
  # source://webmock//lib/webmock/request_pattern.rb#360
  ...
  #   hash, false if not.
  #
  # source://webmock//lib/webmock/request_pattern.rb#344
  def matching_body_hashes?(query_parameters, pattern, content_type); end

  # source://webmock//lib/webmock/request_pattern.rb#364
...
# source://webmock//lib/webmock/request_pattern.rb#373
class WebMock::HeadersPattern
  # @return [HeadersPattern] a new instance of HeadersPattern
  #
  # source://webmock//lib/webmock/request_pattern.rb#374
  def initialize(pattern); end
  ...
  # @return [Boolean]
  #
  # source://webmock//lib/webmock/request_pattern.rb#400
...
module WebMock::NetHTTPUtility
  class << self
    # source://webmock//lib/webmock/http_lib_adapters/net_http.rb#372
    def check_right_http_connection; end

    # source://webmock//lib/webmock/http_lib_adapters/net_http.rb#344
    def get_uri(net_http, path); end

    # source://webmock//lib/webmock/http_lib_adapters/net_http.rb#376
    def puts_warning_for_right_http_if_needed; end

    # source://webmock//lib/webmock/http_lib_adapters/net_http.rb#315
    def request_signature_from_request(net_http, request, body = T.unsafe(nil)); end

    # source://webmock//lib/webmock/http_lib_adapters/net_http.rb#353
